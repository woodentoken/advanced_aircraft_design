...
phase_info = {
    ...
    "climb_1": {
        ...
        "user_options": {
            ...
            "time_duration_bounds": ((10.0, 220.0), "min"),
            "no_descent": True,
        },
    ...
    "cruise_1": {
        ...
        "initial_guesses": {"time": ([40, 200], "min")},
    },
    "descent_1": {
        "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
        "user_options": {
            ...
            "time_duration_bounds": ((25.0, 120.0), "min"),
            "no_climb": True,
        },
        "initial_guesses": {"time": ([240, 100], "min")},
    },
    "cruise_2": {
        "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
        "user_options": {
        ...
        "initial_guesses": {"time": ([330, 180], "min")},
    },
    "descent_2": {
        "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
        "user_options": {
        ...
        "initial_guesses": {"time": ([450, 120], "min")},
    },
    "post_mission": {
