...
phase_info = {
    ...
    "cruise_1": {
        ...
        "user_options": {
            ...
            "time_initial_bounds": ((5.0, 35.0), "min"),
            # "time_duration_bounds": ((400, 1200), "min"),
        },
        "initial_guesses": {"time": ([5, 800], "min")},
    },
    "descent_1": {
        "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
        "user_options": {
            ...
            "mach_bounds": ((0.2, 0.75), "unitless"),
            "mach_polynomial_order": general_mach_poly,
            "altitude_optimize": alt_optimize,
            "altitude_final": (1500.0, "ft"),
            "altitude_bounds": ((1500.0, 35000.0), "ft"),
            "altitude_polynomial_order": 3,
            "throttle_enforcement": "path_constraint",
            # "time_initial_bounds": ((166.5, 600.0), "min"),
            "time_duration_bounds": ((10, 60.0), "min"),
            "no_climb": True,
        },
        "initial_guesses": {"time": ([605, 10], "min")},
    },
    # "cruise_2": {
    #     "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
    #     "user_options": {
    ...
    #     },
    #     "initial_guesses": {"time": ([550, 180], "min")},
    # },
    # "descent_3": {
    #     "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
    #     "user_options": {
    ...
    #         "no_climb": True,
    #     },
    #     "initial_guesses": {"time": ([900, 10], "min")},
    # },
    "post_mission": {
