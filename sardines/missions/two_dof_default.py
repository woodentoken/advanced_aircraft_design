...
phase_info = {
    ...
    "desc1": {
        ...
        "user_options": {
            ...
            "distance_bounds": ((1500.0, 3000.0), "NM"),
        ...
        "initial_guesses": {
            ...
            "distance": ([0.5 * mission_distance, 0.6 * mission_distance], "NM"),
...
def phase_info_parameterization(phase_info, post_mission_info, aviary_inputs):
    ...
    if alt_cruise != old_alt_cruise:
        ...
        phase_info["climb2"]["initial_guesses"]["altitude"] = (
            [10.0e3, alt_cruise],
            "ft",
        )
        phase_info["cruise"]["initial_guesses"]["altitude"] = (alt_cruise, "ft")
        phase_info["desc1"]["initial_guesses"]["altitude"] = (
            [alt_cruise, 10.0e3],
            "ft",
        )
