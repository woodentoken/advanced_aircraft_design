...
def define_phase_info(overrides: dict = None) -> dict:
    ...
    baseline_phase_info = {
        ...
        "accel": {
            ...
            "user_options": {
                ...
                "alt": (500, "ft"),
                "EAS_constraint_eq": (250, "kn"),
                "time_duration_bounds": ((0, 3), "min"),
                "time_duration_ref": (15, "min"),
                "velocity_bounds": ((150, 270), "kn"),
                "velocity_ref": (250, "kn"),
                "velocity_ref0": (150, "kn"),
                "mass_bounds": ((0, None), "lbm"),
        ...
        "climb1": {
            ...
            "user_options": {
                ...
                "mach_cruise": cruise_mach,
                "target_mach": False,
                "time_duration_bounds": ((1, 300), "min"),
                "time_duration_ref": (20, "min"),
                "altitude_final": (cruise_altitude, "ft"),
                "altitude_bounds": ((400.0, 40_000.0), "ft"),
                "altitude_ref": (10.0e3, "ft"),
                "mass_bounds": ((0, None), "lbm"),
                "mass_ref": (100_000, "lbm"),
                "mass_defect_ref": (100_000, "lbm"),
            ...
            "initial_guesses": {
                "time": ([1.0, 60.0], "min"),
                "distance": ([5, 50], "nmi"),
                "altitude": ([500.0, cruise_altitude], "ft"),
                "throttle": ([0.956, 0.956], "unitless"),
            },
        },
        # "climb2": {
        ...
        "cruise1": {
            ...
            "initial_guesses": {
                # [Initial mass, delta mass] for special cruise phase.
                "mass": ([100_481.0, -35000], "lbm"),
                "initial_distance": (200.0e3, "ft"),
                "initial_time": (30.0, "min"),
                "altitude": (cruise_altitude, "ft"),
                "mach": (cruise_mach, "unitless"),
            },
        },
        "desc1": {
            ...
            "user_options": {
                ...
                "mach_cruise": 0.5,
                "input_speed_type": SpeedType.MACH,
                "time_duration_bounds": ((5, 100), "min"),
                "time_duration_ref": (20, "min"),
                "altitude_final": (10_000, "ft"),
                "altitude_bounds": ((1000.0, 30_000.0), "ft"),
                "altitude_ref": (cruise_altitude, "ft"),
                "altitude_ref0": (0, "ft"),
                "altitude_constraint_ref": (10000, "ft"),
                "mass_bounds": ((0, None), "lbm"),
            ...
            "initial_guesses": {
                "mass": (100_000.0, "lbm"),
                "altitude": ([cruise_altitude, 10.0e3], "ft"),
                "throttle": ([0.0, 0.0], "unitless"),
                "distance": ([0.4 * range_nmi, 0.6 * range_nmi], "NM"),
                "time": ([500.0, 30.0], "min"),
            },
        },
        # "cruise2": {
    ...
    return {
        ...
        "baseline_phase_info": baseline_phase_info,
    }
